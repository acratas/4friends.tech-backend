...
const ABI = [{
  ...
  "inputs": [{ "internalType": "address", "name": "sharesSubject", "type": "address" }, {
    "internalType": "uint256",
    "name": "amount",
    "type": "uint256"
  }], "name": "buyShares", "outputs": [], "stateMutability": "payable", "type": "function"
}, {
  "inputs": [{ "internalType": "address", "name": "sharesSubject", "type": "address" }, {
    "internalType": "uint256",
    "name": "amount",
  ...
  "inputs": [{ "internalType": "address", "name": "sharesSubject", "type": "address" }, {
    ...
    "name": "amount",
    "type": "uint256"
  }], "name": "sellShares", "outputs": [], "stateMutability": "payable", "type": "function"
}, {
...
module.exports = (httpProvider, wsProvider, contractAddress) => {
  return {
    http: () => {
    ...
    ws: () => {
      const provider = new Web3.providers.WebsocketProvider(wsProvider);
      const web3 = new Web3(provider);
      return new web3.eth.Contract(ABI, contractAddress);
    }
  }
